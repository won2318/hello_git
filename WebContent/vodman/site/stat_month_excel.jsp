...
int month_count = 0;
String month_contact_count = stat.getStatMonthS(day);
 if (month_contact_count != null && month_contact_count.length() > 2) {
 
	try{
		 month_count = Integer.parseInt(month_contact_count.substring(0,month_contact_count.length()-2));
	}catch(Exception e){
		month_count = 0;
	}
 }

 	response.setHeader("Content-Disposition", "inline; filename=month_stat.xls");
...
<!-- main start-->
                        <table width=640 border=0 cellpadding=0 cellspacing=0>
                          <tr>
                            <td>
							  <table width="640" border="0" cellspacing="0" cellpadding="0" align="center">
							    <tr>
								  ...
								  <td height="30" width="50%" valign="bottom" align="right"></td>
								</tr>
								<tr>
								...
								<tr valign="bottom">
								  <td align="center" class="font1" bgcolor="#F3F3F3" height="250" colspan="3">
									...
									<table border="0" cellspacing="1" cellpadding="0" bgcolor="#666666" height="240" width="640">
									  <tr>
									    <td bgcolor="#FFFFFF" valign="bottom" background="../image/gra1_back.gif">
							...
							<TR>
                              <td width="150" height="15"><%=year%>년 <%=month%>월 <%=i%>일</tD>
							  <TD width="100" align="right"><%=day_cnt%>건&nbsp;</TD>
							  <td width="100"><%= Math.round( (day_cnt / (double)month_count )*100) %>%</td>
                              <TD width="300" valign="middle"><IMG height=12 src="/vodman/include/images/graph.gif" width="<%= Math.round( (day_cnt / (double)month_count )*100) %>%"></TD>
                              </TR>
