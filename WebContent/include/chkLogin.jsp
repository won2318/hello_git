...
<%
    ...
    String SilverLightServer =com.vodcaster.sqlbean.DirectoryNameManager.SILVERLIGHT_SERVERNAME;
    String SilverLightPath = SilverLightServer + "/ClientBin/Media";
    String WowzaServer =com.vodcaster.sqlbean.DirectoryNameManager.WOWZA_SERVER_IP;
%>