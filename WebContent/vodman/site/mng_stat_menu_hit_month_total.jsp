...
<script>
	...
	function Search(){
		location.href='mng_stat_menu_hit_month_total.jsp?mcode=<%=mcode%>&ydate='+document.frmpop.ytime.value+'&mdate='+document.frmpop.mtime.value+'&flag2=M&flag=<%=flag%>';
	}
	
	function ExcelDown(){
		location.href='mng_stat_menu_hit_month_total_excel2.jsp?mcode=<%=mcode%>&ydate='+document.frmpop.ytime.value+'&mdate='+document.frmpop.mtime.value+'&chk_gb='+document.frmpop.chk_gb.value+'&flag=<%=flag%>';
	}
	
	function Popup_OPEN(){
		window.open('mng_stat_menu_hit_month_total_popup.jsp?ydate='+document.frmpop.ytime.value+'&mdate='+document.frmpop.mtime.value+'&flag2=M&flag=<%=flag%>',"new_popup", "width=1200,height=400,scrollbars=yes");
	}
</script>
			...
			<div id="content">
				...
				<caption>메뉴접속통계종합</caption>
						...
						<%
							...
							System.err.println(" mng_stat_menu_hit_month_total.jsp error = "+ex);
						}					
						%>							
					</tbody>
				</tbody>
				...
				<table width="100%">
				<td align="right"></br>&nbsp;&nbsp;<a href="javascript:Popup_OPEN();"><img src="/vodman/include/images/but_view.gif" alt="미리보기" border="0"></a>&nbsp;&nbsp;<a href="javascript:ExcelDown();"><img src="/vodman/include/images/but_excel.gif" alt="Excel받기" border="0"></a></td>
				</tr>
				</table>
				</br></br>
				</form>
