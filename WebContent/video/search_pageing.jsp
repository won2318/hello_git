...
<div class="paginate">
    ...
    <%  if (pageBean.getCurrentPage() != 1) { %>
			<a href="javascript:goPage('1');" class="pre" title="첫페이지"><img src="../css/icon_left3.gif" alt="처음" /></a>
			<!--<img src="/2012/include/images/but_ll.gif" alt="첫페이지" /></a>-->
	<% } %>

	<% if (pageBean.getCurrentBlock() != 1) { %>
			<a href="javascript:goPage('<%=((pageBean.getCurrentBlock()-2)*pageBean.getPagePerBlock()+1)%>');" class="pre" title="이전페이지"><img src="../css/icon_left2.gif" alt="이전" /></a>
	...
	%>
			<a href="javascript:goPage('<%= pageBean.getCurrentBlock()*pageBean.getPagePerBlock()+ 1%>');" class="next" title="다음페이지"><img src="../css/icon_right2.gif" alt="다음" /></a>
	...
	%>
			<a href="javascript:goPage('<%= pageBean.getTotalPage() %>');" class="next" title="마지막페이지"><img src="../css/icon_right3.gif" alt="마지막" /></a>
