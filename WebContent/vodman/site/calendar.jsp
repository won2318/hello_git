...
<%@ page import="com.yundara.util.CharacterSet,com.vodcaster.utils.TextUtil,com.yundara.util.TimeUtil,com.vodcaster.sqlbean.PlanManager,java.util.Date,
                 com.hrlee.sqlbean.MediaManager,
				 com.hrlee.sqlbean.*,
                 java.util.Vector,
...
<!--
    function rtn_date(year,month,day,mode) {
        if(mode == "1") {
            opener.document.quest.rstime1.value = year;
            opener.document.quest.rstime2.value = month;
            opener.document.quest.rstime3.value = day;
            opener.document.quest.rstime4.focus();
            window.close();
        }else {
            opener.document.quest.retime1.value = year;
            opener.document.quest.retime2.value = month;
            opener.document.quest.retime3.value = day;
            opener.document.quest.retime4.focus();            
            window.close();
        }
    }
