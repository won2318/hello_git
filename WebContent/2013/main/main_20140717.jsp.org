					...
					%> 										
								...
								%>
											<span class="sub">
												...
												<span class="txt"><a class="view_page" href="/2013/video/video_player.jsp?ocode=<%=oinfo.getOcode()%>" onclick="StopSilverlight();"><%=title%></a></span>
											</span>
								<%
									if(i%4 == 0){
										out.println("</p>");
...
%>								
				...
				<div class="fr">
					...
					<div id="popup">
						...
						<p class="btn">
							<a href="#popupzone" id="pzPlay" class="btn-play" ><img src="../include/images/main/btn_play.gif" alt="팝업존 재생" /></a><a href="#popupzone" id="pzPlay2" class="btn-stop" ><img src="../include/images/main/btn_pause.gif" alt="팝업존 일시정지" /></a>
						</p>
					</div>
					<script type="text/javascript">
						$("#popup").photoGallery();
