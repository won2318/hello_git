...
vtBts_2 = Best_mgr.getBestTopSubList_order(3, 1); // 명예의 전당
...
-->
				...
				<div class="fr">
					...
					<div class="etc">
						  <ul>
								<li><a href="#url"><img src="../include/images/main/m_etc_icon1.gif" alt="" />154</a></li>
								<li><a href="#url"><img src="../include/images/main/m_etc_icon2.gif" alt="" />11</a></li>
...
<%
				...
				<% 
								...
								%>
					<a href="<%=String.valueOf(((Vector)(popv_C.elementAt(i))).elementAt(8))%>" class="view_page"><img src="/upload/popup/<%=String.valueOf(((Vector)(popv_C.elementAt(i))).elementAt(9))%>" alt="<%=String.valueOf(((Vector)(popv_C.elementAt(i))).elementAt(1))%>"/></a>
					<%
									}
								}
					%>
...
<% 
				...
				<div class="fr">
					...
					<div class="honor_board">
						 ...
						 <div id="honor_board_num">
							<a href="#honor_1"><img src="../include/images/main/1_on.gif" id="honor_img_d1" alt="1"/></a>						
							<a href="#honor_2"><img src="../include/images/main/1_off.gif" id="honor_img_d2" alt="2"/></a>						
							<a href="#honor_3"><img src="../include/images/main/1_off.gif" id="honor_img_d3" alt="3"/></a>	
						</div>						 
						 <ul>
							 <li>
<% 					
	...
	%>							 
									 <p class="photo"><a href="../video/video_player.jsp?ocode=<%=oinfo.getOcode()%>" class="view_page" onclick="StopSilverlight();"><img src="<%=imgTmp %>" alt="<%=oinfo.getTitle()%>"/></a></p>
									 <p class="txt"><a href="../video/video_player.jsp?ocode=<%=oinfo.getOcode()%>" class="view_page" onclick="StopSilverlight();"><%=oinfo.getTitle()%></a></p>
	<%							
