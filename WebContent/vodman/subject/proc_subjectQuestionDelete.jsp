...
<%
    ...
    try {
		int result = subjectbean.delete_question(question_idx);


		if(result >= 0){
			
			out.println("<script language='javascript'>location.href='frm_subjectQuestionList.jsp?sub_idx="+sub_idx+"&sub_flag="+sub_flag+"'</script>");
		}
		else{
