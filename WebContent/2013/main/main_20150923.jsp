...
// 랜덤 메인 영상 설정					
					if (vtBts_4 != null) {
						...
						int random = (int) (Math.random() * vtBts_4.size()) ;
						com.yundara.beans.BeanUtils.fill(btsBean, (Hashtable) vtBts_4.get(random)); 
...
-->
				...
				<div class="fr">
					...
					<div class="etc">
						  <ul>
								<li><img src="../include/images/main/m_etc_icon1.gif" alt="hit수" /><%=oinfo.getHitcount()%></li>
								<li><a href="javascript:point_go('<%=oinfo.getOcode()%>');"><img src="../include/images/main/m_etc_icon2.gif" alt="추천하기" /><span id="recomcount"><%=oinfo.getRecomcount()%></span></a></li>
					...
					%> 										
								...
								%>
											<span class="sub">
												...
												<span class="ranking"><img src="../include/images/icon_best<%=i %>.gif"  alt="<%=i %>"/></span><span class="txt"><a class="view_page" href="/2013/video/video_player.jsp?ocode=<%=oinfo.getOcode()%>" onclick="StopSilverlight();"><%=title%></a></span>
											</span>
								<%
									if(i%4 == 0){
										out.println("</p>");
...
%>								
	...
	<div class="family">
		 <ul class="family_in">
			...
			<li><a href="http://ite.suwon.go.kr/" title="새창으로 연결합니다." target="_blank"><img src="../include/images/family_bann06.gif" alt="시민정보화교육"/></a></li>
		</ul>
	</div>
