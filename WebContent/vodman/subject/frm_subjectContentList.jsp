...
<%
	...
	String strLink = "&page=" +pg+ "&sub_flag="+sub_flag+"&question_idx="+question_idx+"&ans_num="+ans_num;
%>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr bgcolor="#dbe2ed">
		<td colspan="4">&nbsp;&nbsp;▶&nbsp;<%=sub_title%></td>
	</tr>
	<tr bgcolor="#dbe2ed">
		<td height="1" colspan="4"></td>
	</tr>
	<tr style="padding-top: 5px;padding-bottom: 2px">
		<td colspan='4' align='right'>총 <%if(vt != null && vt.size()>0){out.println(pageBean.getTotalRecord());}else{out.println("0");}%>개</tD>
	</tr>
	<tr>
		<td height="1" colspan="4"></td>
	</tr>
	<tr>
		<td height="1" colspan="4" bgcolor="#dbe2ed"></td>
	</tr>
	<tr style="padding-top: 5px;padding-bottom: 2px">
...
%>
	<tr onMouseOver="this.style.backgroundColor='#F6F6F6'" onMouseOut="this.style.backgroundColor=''" style="padding-top: 5px;padding-bottom: 2px">
		...
		<td style="padding-left: 10px"><%=Sin.getAns_order()%><%=Sin.getInfo_order()%></td>
	</tr>
	<tr bgcolor="#dbe2ed">
		<td height="1" colspan="4"></td>
	</tr>
...
%>
	<tr>
		<td colspan="4" align="center">입력된 내용이 없습니다.</td>
	</tr>
<%
		}
%>
...
<%
	String jspName = "frm_subjectContentList.jsp"; 
...
<%	}	%>
	...
	<tr>
		<td colspan='4' align="right">
			<a href="Proc_subjectContentList_excel.jsp?question_idx=<%=question_idx %>&sub_flag=<%=sub_flag %>&ans_num=<%=ans_num %>&user_mf=<%=user_mf %>&page=<%=pg %>">
				<img src="/vodman/include/images/excel_view.gif" border="0">
			</a>
		</td>
	</tr>
</table>
