...
<%@ include file="/vodman/vod_aod/vod_left.jsp"%>
		<div id="contents">
			<h3><%= CategoryManager.getInstance().getCategoryName(info.getCcode(), "V")%></h3>
			...
			<form name='frmMedia' method='post' enctype="multipart/form-data">
				<input type="hidden" id="ocode" name="ocode_old" value="<%=ocode%>"/>
				...
				<input type="hidden" id="ccode" name="ccode" value="<%=info.getCcode()%>"/>
				...
				<tbody>
				  ...
				  <tr>
						...
						<iframe id="fileupload" name="fileupload" src="/vodman/upload/upload.jsp" style="width:90%; height:150px;" scrolling=no  marginwidth=0 frameborder=0 framespacing=0 ></iframe><br/>
						</td>
					</tr>
					<tr class="height_25">
...
<!-- 						</select> -->
					...
					<tr>
						...
						<td class="bor_bottom01 pa_left" colspan="3" >
						<textarea name="description" id="description" style="width:620px;height:300px; display:none;" cols="100" rows="60" ><%=info.getDescription()%></textarea>
