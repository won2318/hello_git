...
<script language='javascript'>
	...
	function photo_view(board_id,list_id){
		sv_wm_viewer = window.open("pop_photo_viewer.jsp?board_id="+board_id+"&list_id="+list_id,"photo_viewer","toolbar=no,location=no,directories=no,status=no,menubar=no,resizable=no, scrollbars=yes,width=600,height=630\"");
	}
