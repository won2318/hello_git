...
<%
    ...
    try {
		int result = subjectbean.insert_event_user(request);


		if(result >= 0){

			out.println("<script language='javascript'>opener.location.reload();location.href='frm_subject_event.jsp?sub_idx="+sub_idx+"&sub_flag="+sub_flag+"'</script>");
