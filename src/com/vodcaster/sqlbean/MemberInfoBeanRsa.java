 ...
 * 회원테이블 정보 관리 클래스
 */
public class MemberInfoBeanRsa extends InfoBeanExt {
    ...
    private String login_check="";			//로그인 제한
	...
	public String getBuseo() {
        //return buseo;
        return SEEDUtil.getDecrypt(buseo);
    }
    ...
    public String getGray() {
        //return gray;
        return SEEDUtil.getDecrypt(gray);
    }
    ...
    public String  getMember_group() {
        //return member_group;
    	return SEEDUtil.getDecrypt(member_group);
    }
    ...
    public String  getPwd_answer() {
        //return pwd_answer;
    	return SEEDUtil.getDecrypt(pwd_answer);
    }
    ...
    public String getAddress1() {
        //return address1;
    	return SEEDUtil.getDecrypt(address1);
    }
    /**
    ...
    public String getAddress2() {
        //return address2;
    	return SEEDUtil.getDecrypt(address2);
    }
    /**
    ...
    public String getEmail() {
        //return email;
    	return SEEDUtil.getDecrypt(email);
    }
    /**
    ...
    public String getOffice_name() {
        //return office_name;
    	return SEEDUtil.getDecrypt(office_name);
    }
    /**
    ...
    public String getTel() {
        //return tel;
    	return SEEDUtil.getDecrypt(tel);
    }
    /**
    ...
    public String getZip() {
        //return zip;
    	return SEEDUtil.getDecrypt(zip);
    }
    /**
