...
<%
	...
	if(LOGOUT == null || LOGOUT.length()<=0 || LOGOUT.equals("null")){
		...
		if(tmp_id == null || vod_name == null || tmp_id.length()<=0 || tmp_id.equals("null")){
				...
				<%
				//out.println("<script>location.href='/vodman/mancheck.jsp';</script>");
				return;
	...
	//==============================================================================
	//주소를 직접 치고 접근하는 경우를 차단하기 위한 처리 
	String strReferer = request.getHeader("referer");
/*	if(strReferer == null || strReferer.indexOf(DirectoryNameManager.SERVERNAME) == -1){
		session.invalidate();
