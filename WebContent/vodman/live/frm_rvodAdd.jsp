...
<%@ include file="/vodman/live/live_left.jsp"%>
		<!-- 컨텐츠 -->
		<div id="contents">
			<h3><span>생방송</span> 등록</h3>
			<p class="location">관리자페이지 &gt; 생방송관리 &gt; <span>생방송 등록</span></p>
			<div id="content">
				<!-- 내용 -->
				...
				<tbody class="bor_top03">
					...
					<tr class="height_25 font_127">
						...
						<input type="radio" name="inoutflag"  value="Y" checked="checked" /> 내부용&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="inoutflag"  value="N" /> 내외부용&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="inoutflag"  value="X" /> 외부용</td>
					</tr>
					...
					<tr class="height_25">
						...
						<td class="bor_bottom01 pa_left">WEB <input type="text" name="ralias" maxlength="100" value="" class="input01" style="width:350px;" onkeyup="checkLength(this,100)"/> <br/> 예) /live/live.stream, &nbsp;&nbsp;&nbsp; /live/suwon01r.stream</td>
					</tr>
					<tr>
