...
//-->
	...
	<div id="container_in">
		<div id="main_content">
			...
			<!-- main -->
			<div class="section1">
			    <div class="fl"><img src="../include/images/main/section1_movie.jpg" alt=""/></div>
				<div class="fr">
					<div class="fr_in">
							<p class="title"><a class="" href="#" onclick="">사람중심, 더큰 수원!<br />[민선6기 취임기념 영상]</a></p>
							<p class="subject">
							민선 6기 수원시가 7월 1일, 출발을 알린 가운데 염태영 수원시장이 민선6기 시정목표로 제시한 안전한 공정사회로의 첫발을 내밀었습니다. 							
							</p>
					</div>
				</div>
			</div>
			<div class="section2">
			    <div class="fl">
					...
					<div class="new_movie">
					   ...
					   <div class="new_movie_in">
					     <ul>
							 <li class="first">
								 <p class="photo"><a href="#"><img src="../include/images/main/sample_photo1.gif" alt=""/></a></p>
			...
			<div class="section3">
			    <div class="fl">
					...
					<div id="board_best" class="best">
						 ...
						 <div id="board_tab1_view" class="best_list">			  
							  <ul>
								 <li class="first">
									 <p class="photo"><a href="#"><img src="../include/images/main/sample_photo2.gif" alt=""/></a></p>
									 <p class="txt"><a href="#">[세상의 모든 여행] 조여정의 인도네시아 ..</a></p>
								 </li>
								 <li >
									 <p class="photo"><a href="#"><img src="../include/images/main/sample_photo1.gif" alt=""/></a></p>
				...
				<div class="fr">
					...
					<div class="honor_board">
						 ...
						 <ul>
							 <li>
								 <p class="photo"><a href="#url"><img src="../include/images/main/sample_photo3.gif" alt=""/></a></p>
								 <p class="txt"><a href="#url">이번엔 숲 속이다!</a></p>
							 </li>
						 </ul>
					</div>
					<!-- //honor_board -->
					...
					<div class="fl_box1">
						<div class="board_movie">
						   <h3><img src="../include/images/main/h3_board_movie.gif" alt="추천영상"/></h3>
							<ul>
								<li><a href="#url">[수원Zone] 2014 브라질 월드컵 태극전사를 응원...</a></li>
								<li><a href="#url">[시민공감] 미래의 축구스타를 꿈꾼다!...</a></li>
								<li><a href="#url">[수원Zone] 이제 글로벌뉴스로 수원을 만난다!</a></li>
								<li><a href="#url">[수원Zone] 2014 브라질 월드컵 태극전사를 응원...</a></li>
								<li><a href="#url">[시민공감] 미래의 축구스타를 꿈꾼다!...</a></li>
								<li><a href="#url">[수원Zone] 이제 글로벌뉴스로 수원을 만난다!</a></li>
							</ul>
