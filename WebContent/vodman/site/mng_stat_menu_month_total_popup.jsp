...
<script>
	...
	function Search(){
		location.href='mng_stat_menu_month_total_popup.jsp?ydate='+document.frmpop.ytime.value+'&mdate='+document.frmpop.mtime.value;
	}
	
	function ExcelDown(){
		alert("om");
		location.href='mng_stat_menu_month_total_excel2.jsp?ydate='+document.frmpop.ytime.value+'&mdate='+document.frmpop.mtime.value;
	}
</script>
		<!-- 컨텐츠 -->
		<div>			
