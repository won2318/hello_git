...
<!-- 				</div>//생방송안내(생방송이 있을때만 표출:mLive -->
				<div class="vodView">
					<h3><%=title%></h3>
					<div class="data1"><span><%=mk_date %></span>|<span>방송시간 : <%=playtime %></span></div>
...
<!-- 								  <iframe src="https://www.youtube.com/embed/hpazy0BHzxY" frameborder="0" allowfullscreen></iframe> -->
									...
									<video width="90%" controls="controls" src="<%=media_url%>"  poster="<%=imgTmp%>" allowfullscreen="false"></video>
<%-- 									<a href="<%=media_url%>"><span class="playBig"></span><img src="<%=imgTmp%>" alt="<%=title%>" width="100%"/></a> --%>
					...
					<span class="sns">
						...
						<a id="kakao-link-btn" href="javascript:;"><img src="../include/images/sns_cacaotalk.gif" alt="cacao talk"/></a>
