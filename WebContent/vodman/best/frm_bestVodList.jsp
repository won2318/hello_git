...
<!-- 						<option value="">--- 세분류 선택 ---</option> -->
			...
			<tr>
				<td colspan="4" class="bor_top04 bor_bottom02 height_25" align="center"><p class="to_page">Total<b><%=totalArticle%></b>Page<b><%=pg%>/<%if(vt != null && vt.size() >0 && pageBean.getTotalPage() > 0){out.println(pageBean.getTotalPage());}else{out.println("0");}%></b></p></td>
			</tr>
			<tr>
...
%>
					<table cellspacing="0">
						<tr>
							<td rowspan="2" class="pa_left"><input type="checkbox" id="check_<%=String.valueOf(oinfo.getOcode())%>" name="check_<%=String.valueOf(oinfo.getOcode())%>" value="<%=String.valueOf(oinfo.getOcode())%>" onclick="set_ocode('<%=String.valueOf(oinfo.getOcode())%>');" /></td>
...
%>
			...
			<tr>
				<td colspan="4"><%@ include file="page_link.jsp" %>
