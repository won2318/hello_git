...
<%-- 					<iframe title="실버라이트 동영상 재생 창" id="silver_player" name="silver_player" src="/silverPlayer.jsp?ocode=<%=ocode%>&width=579&height=370&auto_p=<%=auto_p%>" scrolling="no" width="579" height="370" marginwidth="0" frameborder="0" framespacing="0" ></iframe> --%>
				<iframe title="동영상 재생 창" id="video_player" name="video_player" src="/videoJs/jsPlayer.jsp?ocode=<%=ocode%>&type=sub" scrolling="no" width="579" height="370" marginwidth="0" frameborder="0" framespacing="0" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" oallowfullscreen="true" msallowfullscreen="true"></iframe>
...
<%-- 						<input type="hidden" name="pwd" value="<%=comment_pwd %>" /> --%>
		...
		<div class="pAside">
			...
			<div class="pLink">
				<span>공유하기 <a href="javascript:copy_select();"><img src="../include/images/icon_view_link.gif" alt="링크"/></a>  <a href="javascript:twitter_share();"><img src="../include/images/icon_view_twitter.gif" alt="트위터"/></a> <a href="javascript:facebook_share();"><img src="../include/images/icon_view_facebook.gif" alt="페이스북"/></a></span>
			</div>
