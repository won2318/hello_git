...
// 		                 	temp_writer += list_name.substring(list_name.length()-1, list_name.length());
			...
			<span class="pFile" style="background:none; padding-left: 0; border-bottom:1px solid #e4e6e8;">Link : <a href="<%=list_link%>" target="_blank"><%=list_link%></a></span>
			<%}%>
			<div class="pSubject">
...
<%-- 						<input type="hidden" name="pwd" value="<%=comment_pwd %>" /> --%>
			...
			<% if (board_auth_write == 0) { %>
					<a href="javascript:pwd_check('update');"><img src="../include/images/btn_edit.gif" alt="수정" class="img"/></a>
					<a href="javascript:pwd_check('delete');"><img src="../include/images/btn_del.gif" alt="삭제" class="img"/></a>
			<%} else { %>
