...
%>
	<table cellspacing="0" class="connection_view01" summary="주간시청현황">
	<caption>주간시청현황</caption>
	<colgroup>
		<col width="7%"/>
		<col/>
		<col width="7%" span="12"/>
	...
	<thead>
	<tr>
		<th colspan="12" class="connection_view01_title"><b>주간시청현황</b></th>
...
if(request.getParameter("flag") != null && request.getParameter("flag").length()>0 && !request.getParameter("flag").equals("null")){
	...
	//일별 접속 통계
	row=stat.getWeekStatTemp_hit(iDateSum-START_DAY_OF_WEEK+1,flag);
%>
