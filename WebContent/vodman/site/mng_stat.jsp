...
<%@ include file="/vodman/site/site_left.jsp"%>
		...
		<div id="contents">
			...
			<div id="content">
					...
					<!-- 내용 -->
					<ul class="s_tab01_bg">
					<li><a href="mng_stat.jsp?mcode=<%=mcode%>&flag=W" title="Web" <%if(flag.equals("W")){out.println("class='visible'");}%>>Web</a></li>
					<li><a href="mng_stat.jsp?mcode=<%=mcode%>&flag=M" title="Mobile" <%if(flag.equals("M")){out.println("class='visible'");}%>>Mobile</a></li>
				</ul><br><br>
				...
				<iframe id="week_stat" name="week_stat" src="mng_week.jsp?flag=<%=flag%>" scrolling=no width="795" height='300' marginwidth=0 frameborder=0 framespacing=0 ></iframe>
				
				<br/><br/>

				<iframe id="month_stat" name="month_stat" src="mng_month.jsp?flag=<%=flag%>" scrolling=no width="795" height='320' marginwidth=0 frameborder=0 framespacing=0 ></iframe>

				<br/><br/>
				
				<iframe id="month_stat_time" name="month_stat_time" src="mng_month_time.jsp?flag=<%=flag%>" scrolling=no width="795" height='320' marginwidth=0 frameborder=0 framespacing=0 ></iframe>

				<br/><br/>

				<iframe id="year_stat" name="year_stat" src="mng_year.jsp?flag=<%=flag%>" scrolling=no width="795" height='300' marginwidth=0 frameborder=0 framespacing=0 ></iframe>
