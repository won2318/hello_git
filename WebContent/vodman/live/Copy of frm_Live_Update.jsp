...
<%
	...
	String rflag = request.getParameter("rflag").replaceAll("<","").replaceAll(">","");
	if(rflag == null) rflag = "L";
...
<%@ include file="/vodman/live/live_left.jsp"%>
		...
		<div id="contents">
			...
			<div id="content">
				...
				<table cellspacing="0" class="live_view" summary="생방송 수정">
				...
				<tbody class="bor_top03">
					<tr class="height_25">
						...
						<td class="bor_bottom01 pa_left"><input type="text" name="rtitle" maxlength="200" value="<%=linfo.getRtitle()%>" class="input01" style="width:350px;"  onkeyup="checkLength(this,200)" /></td>
					</tr>
 
					<tr class="height_25 font_127">
						<th class="bor_bottom01 back_f7"><strong>내외부용</strong></th>
						<td class="bor_bottom01 pa_left"><input type="radio"  name="inoutflag"  value="Y" <% if (linfo.getInoutflag().equals("Y")) {out.println("checked");} %> /> 내부용&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio"  name="inoutflag"  value="N" <% if (linfo.getInoutflag().equals("N")) {out.println("checked");} %>/> 내외부용</td>
					</tr>
 
					<tr class="height_25 font_127">
						<th class="bor_bottom01 back_f7"><strong>내용</strong></th>
						<td class="bor_bottom01 pa_left"><textarea name="rcontents" class="input01" style="width:350px;height:50px;" cols="100" rows="100"  onKeyUp="return checkLength(this,2000);" maxlength="2000" ><%=linfo.getRcontents()%></textarea></td>
					</tr>
					<tr class="height_25">
						<th class="bor_bottom01 back_f7" rowspan="2"><strong>채널</strong></th>
						<td class="bor_bottom01 pa_left">WEB <input type="text" name="ralias" maxlength="100" value="<%=linfo.getRalias()%>" class="input01" style="width:300px;" onkeyup="checkLength(this,100)"/> <br/> 예) /live/live.stream</td>
					</tr>
					<tr>
						<td class="bor_bottom01 pa_left">MOBILE <input type="text" name="mobile_stream" maxlength="100" value="<%=linfo.getMobile_stream()%>" class="input01" style="width:290px;" onkeyup="checkLength(this,100)"/> <br/> 예) live/live.stream </td>
					</tr>
					<tr>
					...
					<tr class="height_25">
						...
						<td class="bor_bottom01 pa_left"><input type="text" name="rbcast_time" maxlength="30" value="<%=linfo.getRbcast_time()%>" class="input01" style="width:350px;"  onkeyup="checkLength(this,30)" /></td>
					</tr>
					<tr class="height_25 font_127">
...
<!--
 ...
 -->									
					...
					<tr class="height_25 font_127">
						...
						<td class="bor_bottom01 pa_left"><input type="text" name="otitle" maxlength="100" value="<%=linfo.getOtitle()%>" class="input01" style="width:300px;"/>&nbsp;<input type="checkbox" name="vod_del" value="Y" />삭제
							<br /> ※ 오른쪽 동영상 목록의 체크박스를 선택하세요.
							<input type="hidden" value="<%=linfo.getOcode()%>" name="ocode">
						</td>
					</tr>
					<tr class="height_25 font_127">
						<th class="bor_bottom01 back_f7"><strong>관련영상2</strong></th>
						<td class="bor_bottom01 pa_left"><input type="text" name="otitle2" maxlength="100" value="<%=linfo.getOtitle()%>" class="input01" style="width:300px;"/>&nbsp;<input type="checkbox" name="vod_del2" value="Y" />삭제
							<br /> ※ 오른쪽 동영상 목록의 체크박스를 선택하세요.
							<input type="hidden" value="<%=linfo.getOcode()%>" name="ocode2">
						</td>
					</tr>
					<tr class="height_25 font_127">
						<th class="bor_bottom01 back_f7"><strong>관련영상3</strong></th>
						<td class="bor_bottom01 pa_left"><input type="text" name="otitle3" maxlength="100" value="<%=linfo.getOtitle()%>" class="input01" style="width:300px;"/>&nbsp;<input type="checkbox" name="vod_del3" value="Y" />삭제
							<br /> ※ 오른쪽 동영상 목록의 체크박스를 선택하세요.
							<input type="hidden" value="<%=linfo.getOcode()%>" name="ocode3">
						</td>
					</tr>
					<tr>
						<td colspan="2">
 			...
 			<iframe id="liveVodList" name="liveVodList" src="frm_liveVodList.jsp?ocode=<%=linfo.getOcode()%>" style="width:340px; height:520px; float:right;" scrolling=no  marginwidth=0 frameborder=0 framespacing=0 ></iframe>
			</div>
		</div>	
