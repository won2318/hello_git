...
if(hValue.indexOf("Android") != -1)
 ...
 String rcode ="";
  ...
  if(v_onair != null && v_onair.size() > 0) {  
 	 out.print("<a href='"+live_url+"'><span class='onair'>ON-AIR</span><strong>积规价 矫没窍扁</strong></a>");
  } else {
	  out.print("<a href='LiveSchedule.jsp'><span class='onair_no'>OFF</span><strong>积规价 救郴</strong></a>");
  }
 %>