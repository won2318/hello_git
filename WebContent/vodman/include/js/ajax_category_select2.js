...
/*
param : category값, target : 변할 select id, info : category info(A, B, C..)
*/
...
function refreshCategoryListV(ctype, param, info,target) {
    ...
    var url = "/vodman/include/category_select2v.jsp?ctype="+ctype+"&info="+info+"&vcategory="+param;
...
function refreshCategoryList_AV(ctype, param, info, ccode ) {
    ...
    var url = "/vodman/include/category_select2v.jsp?ctype="+ctype+"&info="+info+"&vcategory=";
...
function refreshCategoryList_BV(ctype, param, info, ccode ) {
    ...
    var url = "/vodman/include/category_select2v.jsp?ctype="+ctype+"&info="+info+"&vcategory="+cate2v;
...
//	alert(selectArr);
    ...
    var url = "/vodman/include/category_select2.jsp?ctype="+ctype+"&info="+info+"&category="+param;
...
function refreshCategoryList_A(ctype, param, info, ccode ) {
	...
	targetId = param; 
    var url = "/vodman/include/category_select2.jsp?ctype="+ctype+"&info="+info+"&category=";
...
function refreshCategoryList_B(ctype, param, info, ccode ) {
	...
	targetId = param; 
    var url = "/vodman/include/category_select2.jsp?ctype="+ctype+"&info="+info+"&category="+cate2;
...
function refreshCategoryList_C(ctype, param, info, ccode ) {
	...
	targetId = param; 
    var url = "/vodman/include/category_select2.jsp?ctype="+ctype+"&info="+info+"&category="+cate3;
...
function refreshCategoryList_D(ctype, param, info, ccode ) {
	...
	cate4 = ccode ;
	targetId = param; 
    var url = "/vodman/include/category_select2.jsp?ctype="+ctype+"&info="+info+"&category="+cate4;
