...
<%@ include file="/vodman/vod_aod/vod_left.jsp"%>
		<div id="contents">
			...
			<div id="content">
				<table cellspacing="0" class="board_view" summary="인코딩 옵션 수정">
				<caption>인코딩 옵션 수정</caption>
				<colgroup>
					<col />
				</colgroup>
				<tbody>
    ...
    <div id="silverlightControlHost">
		<object id="SilverPlayer" data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="100%" height="700">
			<param name="source" value="<%=DirectoryNameManager.SILVERLIGHT_SERVERNAME%>/ClientBin/OptionManagerNoMobile.xap"/>
