...
//	session.putValue("random_num", "");
	...
	if(result >= 0){
		...
		out.println("top.location.href='iTV_board.jsp?board_id="+board_id+"&searchField="+searchField+"&searchString="+searchstring+"&page="+pg +"';");
		out.println("</SCRIPT>");
		...
		out.println("<SCRIPT LANGUAGE='JavaScript'>");
		out.println("alert('처리 중 오류가 발생하였습니다11.');");
		out.println("history.go(-1);");
		out.println("</SCRIPT>");
	}
%>