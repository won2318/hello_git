...
<%
	...
	if (request.getParameter("search_true")!= null &&  request.getParameter("search_true").equals("Y")){
		vt = mgr.getOVODMemberList3_group__mobile( rstime, retime, ocode, user_id, ccode, dept, grade);
	}
	...
	******************************************************************************/
	...
	if(vt != null && vt.size() >0){
		...
		jspName="mng_view_stat_mobile.jsp";
...
<script language="javascript" src="/vodman/include/ajax_category_select.js"></script>
...
<!--
	...
	function search() {
	    document.frmMedia.action = "mng_view_stat_mobile.jsp";
		...
		<div id="contents">
			...
			<div id="content">
				...
				<div id="tab01">
					...
					<li ><a href="mng_view_stat_mobile.jsp?mcode=<%=mcode%>" title="Mobile-VOD" class='visible'>Mobile-VOD</a></li>
					<li ><a href="mng_view_stat_mobileL.jsp?mcode=<%=mcode%>" title="Mobile-LIVE" >Mobile-LIVE</a></li>
					</ul>
				...
				<tbody>
					<tr>
						...
						<td class="bor_bottom01 pa_left" colspan="3">
							<select id="ccategory1" name="ccategory1" class="sec01" style="width:120px;" onchange="javascript:setCcode(document.frmMedia, this.value);refreshCategoryList('<%=ctype%>', this.value, 'B', 'ccategory2');">
...
<!-- 
							<select id="ccategory3" name="ccategory3" class="sec01" style="width:120px;" onchange="javascript:refreshCategoryList('<%=ctype%>', this.value, 'D', 'ccategory4');">
 ...
 -->
					...
					<tr>
						...
						<td class="bor_bottom01 pa_left">
							<iframe name="vlist" src="./frame_vlist.jsp?ocode=<%=ocode%>&ctype=<%=ctype%>" scrolling="no" width="300" height="21" marginwidth="0" frameborder="0" framespacing="0" ></iframe>
						</td>
						<th class="bor_bottom01"><strong>회원ID</strong></th>
						<td class="bor_bottom01 pa_left"><input type="text" name="user_id" value="<%=user_id%>" class="input01" style="width:150px;"/></td>
					</tr>
<!-- 
					<tr>
...
-->
					<tr>
						...
						<td class="bor_bottom01 pa_left" colspan="3">
						<input type="text" name="rstime" value="<%=rstime%>" class="input01" style="width:80px;" onkeypress="onlyNumber();" />
						...
						<input type="text" name="retime" value="<%=retime%>" class="input01" style="width:80px;" onkeypress="onlyNumber();" />
				...
				<div class="to_but">
					...
					<p class="align_right02 height_25"><a href="mng_view_stat_mobile_excel.jsp?<%=strLink%>" title="엑셀받기"><img src="/vodman/include/images/but_excel.gif" alt="엑셀받기"/></a></p>
				</div>
