...
//	alert(selectArr);
    ...
    var url = "../video/category_select.jsp?ctype="+ctype+"&info="+info+"&category="+param;
...
function refreshCategoryList_A(ctype, param, info, ccode ) {
    ...
    var url = "../video/category_select.jsp?ctype="+ctype+"&info="+info+"&category=";
...
function refreshCategoryList_B(ctype, param, info, ccode ) {
    ...
    var url = "../video/category_select.jsp?ctype="+ctype+"&info="+info+"&category="+cate2;
...
function refreshCategoryList_C(ctype, param, info, ccode ) {
    ...
    var url = "../video/category_select.jsp?ctype="+ctype+"&info="+info+"&category="+cate3;
...
function refreshCategoryList_D(ctype, param, info, ccode ) {
    ...
    var url = "../video/category_select.jsp?ctype="+ctype+"&info="+info+"&category="+cate4;
