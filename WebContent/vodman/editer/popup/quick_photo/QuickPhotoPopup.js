    ...
    function html5Upload() {	
    	...
    	sUploadURL= 'http://newsuwon.withustech.com/vodman/editer/popup/quick_photo/FileUploader_html5.php'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader(){			
 			...
 			sUrl  : '/vodman/editer/popup/quick_photo/FileUploader.jsp',	 
 	        sCallback : '/vodman/editer/popup/quick_photo/callback.html',	  
// 			sUrl  : 'http://tv.suwon.go.kr/vodman/editer/popup/quick_photo/FileUploader.jsp',	//샘플 URL입니다.
// 	        sCallback : 'http://tv.suwon.go.kr/vodman/editer/popup/quick_photo/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
