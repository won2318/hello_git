			...
			if(vt != null && vt.size()>0) {
				for(int i=0; i<vt.size(); i++) {
					...
					int nb = vt.size();
						...
						String Cmonth 		= TextUtil.nvl(String.valueOf(ht_list.get("cmonth")));
						String Cyear 		= TextUtil.nvl(String.valueOf(ht_list.get("cyear")));
						String Cday 		= TextUtil.nvl(String.valueOf(ht_list.get("cday")));
						String ctitle		= TextUtil.nvl(String.valueOf(ht_list.get("ctitle")));
						
						row.getCell(0).setCellValue((String)ctitle);
						row.getCell(1).setCellValue((String)Cday);
						row.getCell(2).setCellValue((String)Cmonth);
						row.getCell(3).setCellValue((String)Cyear);
						
						today_contact_count += Integer.parseInt(Cday);
						month_contact_count += Integer.parseInt(Cmonth);
						total_contact_count += Integer.parseInt(Cyear);
							
				}
				Row row1 = sheet.getRow(vt.size()+2);
				row1.getCell(0).setCellValue("합계");
				row1.getCell(1).setCellValue(today_contact_count);
				row1.getCell(2).setCellValue(month_contact_count);
				row1.getCell(3).setCellValue(total_contact_count);
