...
<%
	...
	******************************************************************************/
	...
	if(vt != null && vt.size() >0){
		...
		jspName="mng_view_stat_live.jsp";
...
function search() {
    document.frmMedia.action = "mng_view_stat_live.jsp";
		...
		<div id="contents">
			...
			<div id="content">
				...
				<div id="tab01">
					...
					<ul class="s_tab01_bg">
					<li ><a href="mng_view_stat.jsp?mcode=<%=mcode%>&ctype=V" title="VOD">PC VOD</a></li>
					<li ><a href="mng_view_stat.jsp?mcode=<%=mcode%>&ctype=H" title="Mobile VOD" >Mobile VOD</a></li>
					<li ><a href="mng_view_stat_live.jsp?mcode=<%=mcode%>&ctype=R" title="LIVE" <%if(ctype.equals("R")){out.println("class='visible'");}%>'>PC LIVE</a></li>
					<li ><a href="mng_view_stat_live.jsp?mcode=<%=mcode%>&ctype=L" title="LIVE" <%if(ctype.equals("L")){out.println("class='visible'");}%>>Mobile LIVE</a></li>
					</ul>
				...
				<tbody>
					<tr>
						<th class="bor_bottom01"><strong>생방송제목</strong></th>
						...
						<td class="bor_bottom01 pa_left"><input type="text" name="user_id" value="" class="input01" style="width:150px;" maxlength="15" /></td>
					</tr>
<!-- 
					<tr>
 ...
 -->
					<tr>
						...
						<input type="text" name="rstime" value="" class="input01" style="width:80px;" onkeypress="onlyNumber();" readonly />
						...
						<input type="text" name="retime" value="" class="input01" style="width:80px;" onkeypress="onlyNumber();" readonly />
