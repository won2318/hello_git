...
///////////////////////////////////
	...
	Vector noticeVt1 = blsBean.getRecentBoardList_open(10, 6); // 공지 (board_id, limit)
				...
				<div class="silver">
					...
					<%  if(live_v != null && live_v.size() > 0) {%>
						<script type="text/javascript" >
							...
							<noscript>
							<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="522px" height="339px" id="live" align="middle">
							...
							<embed src="/2013/live/live_wide.swf" quality="high" bgcolor="#000000" width="522px" height="339px" name="live_wide" align="middle" 
					...
					<span class="sub">
						...
						<span class="more"><a href="javascript:live_open();" ><img src="../include/images/btn_today_more.gif" alt="자세히보기"/></a>
						</span>
 					</span>	
				    <%} else {%>
...
%>	
				...
				<div class="mNotice">
					<h3><a href="http://newsuwon.withustech.com/2013/board/board_list.jsp?board_id=10">공지사항</a></h3>
...
%>
				 ...
				 <%if (cnt ==1) { %>
				<li class="big">
					<span class="img"><a class="view_page" href="../video/video_player.jsp?ocode=<%=oinfo.getOcode()%>" onclick="StopSilverlight();"><span class="playMid"></span><img src="<%=imgTmp %>" alt="<%=oinfo.getTitle()%>"/></a></span>
					<span class="total">
				...
				<%} else { %>
				<li class="small">
					<span class="img"><a class="view_page" href="../video/video_player.jsp?ocode=<%=oinfo.getOcode()%>" onclick="StopSilverlight();"><span class="playSmall2"></span><img src="<%=imgTmp %>" alt="<%=oinfo.getTitle()%>"/></a></span>
				</li>
				<%} %>
