...
-->
			...
			<div class="section2">
			    <div class="fl">
					...
					%>
							 <li <%=i==1?"class='first'":""%>>
								 <p class="photo"><a class="view_page" href="../video/video_player.jsp?ocode=<%=oinfo.getOcode()%>" onclick="StopSilverlight();"><img src="<%=imgTmp%>" alt="<%=oinfo.getTitle()%>"/></a></p>
								 <p class="txt"><a class="view_page" href="../video/video_player.jsp?ocode=<%=oinfo.getOcode()%>" onclick="StopSilverlight();"><%=temp_ctitle%></a></p>
							 </li>
							<%
							if(i%4 == 0){
								out.println("</ul>");
